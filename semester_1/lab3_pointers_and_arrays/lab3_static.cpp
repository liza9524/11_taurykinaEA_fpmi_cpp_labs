...
int main()
{
    ...
    std::cout << std::endl << "number of element such that sum of elements before it differs leats from the sum of elements after it is " << FindSum(arr, n) << std::endl;
    //task 20.2

    FindMax(arr, n);

    //extra
    std::cout << "enter the left segment board ";
    std::cin >> left_board;
    std::cout << std::endl << "enter the right segment board ";
    std::cin >> right_board;
    std::cout << std::endl;
